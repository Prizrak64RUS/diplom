...
public class ControllerGroup implements InterfaceGroup {
    ...
    @ResponseBody
    public int setGroup(@RequestBody final Group g) {
    ...
    @RequestMapping(method = RequestMethod.POST, consumes="application/json", produces ="application/json", value=UrlController.groupEnd)
    @ResponseBody
    public boolean endGroup(@RequestBody final Integer val) {
        return ControllerConnections.getGroupController().endGroup(val);
    }
}
