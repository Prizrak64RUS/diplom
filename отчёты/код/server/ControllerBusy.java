...
public class ControllerBusy implements InterfaceBusy{
    ...
    @RequestMapping(method = RequestMethod.POST, consumes="application/json", produces ="application/json", value=UrlController.busyGet)
    @ResponseBody
    public ArrayList<Busy> getBusys(@RequestBody Busy b) {
        return ControllerConnections.getBusyController().getBusys(b);
    }
}